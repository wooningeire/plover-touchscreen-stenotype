...
def build_layout_descriptor(settings: Settings, keyboard_widget: KeyboardWidget) -> LayoutDescriptor:
    ...
    num_bar_key_height = common_params.num_bar_key_height
    ...
    top_row_key_height = reduced_size(reduced_key_height, compound_key_height_small)
    top_row_key_height_small = reduced_size(reduced_key_height_small, compound_key_height_small)

    asterisk_row_heights = (
        num_bar_key_height,
        compound_key_height_small,
        top_row_key_height_small,
        compound_key_height_small,
                    ...
                    Group(
                        ...
                        elements=(
                            KeyGroup(
                                ...
                                elements=(
                                    Key(steno="#", height=num_bar_key_height),
                                    Key(steno="#S", height=compound_key_height_small),
                                    Key(steno="S", label=num_bar_affected_label("S", "1"), height=top_row_key_height + reduced_key_height_small + compound_key_height_small + pinky_offset / 2),
                                ),
                            ),
                            KeyGroup(
                                alignment=GroupAlignment.BOTTOM_RIGHT,
                                ...
                                elements=(
                                    Key(steno="#", height=num_bar_key_height),
                                    Key(steno="#T", height=compound_key_height_small),
                                    Key(steno="T", label=num_bar_affected_label("T", "2"), height=top_row_key_height),
                            ...
                            KeyGroup(
                                ...
                                elements=(
                                    Key(steno="#", label="#", height=num_bar_key_height),
                                    Key(steno="#P", height=compound_key_height_small),
                                    Key(steno="P", label=num_bar_affected_label("P", "3"), height=top_row_key_height),
                            ...
                            KeyGroup(
                                ...
                                elements=(
                                    Key(steno="#", grid_location=(0, 0, 1, 3)),
                                    Key(steno="#H", grid_location=(1, 0)),
                                    Key(steno="#H*", grid_location=(1, 1)),
                                    Key(steno="#*", grid_location=(1, 2)),
                                    Key(steno="*", label="🞱", grid_location=(2, 2, 3, 1)),
                                    Key(steno="H", label=num_bar_affected_label("H", "4"), grid_location=(2, 0)),
                                    Key(steno="HR", grid_location=(3, 0)),
                                    Key(steno="R", label="R", grid_location=(4, 0)),
                                    Key(steno="H*", grid_location=(2, 1)),
                                    Key(steno="HR*", grid_location=(3, 1)),
                                    Key(steno="R*", grid_location=(4, 1)),
                                ),
                            ),
                        ),
                    ),
                        ...
                        elements=(
                            KeyGroup(
                                ...
                                elements=(
                                    ...
                                    Key(steno="#*F", grid_location=(1, 1)),
                                    Key(steno="#-F", grid_location=(1, 2)),
                                    Key(steno="*", label="🞱", grid_location=(2, 0, 3, 1)),
                                    Key(steno="*F", grid_location=(2, 1)),
                                    Key(steno="*FR", grid_location=(3, 1)),
                                    Key(steno="*R", grid_location=(4, 1)),
                                    Key(steno="-F", label=num_bar_affected_label("F", "6"), grid_location=(2, 2)),
                                    Key(steno="-FR", grid_location=(3, 2)),
                                    Key(steno="-R", label="R", grid_location=(4, 2)),
                                ),
                            ),
                            KeyGroup(
                                alignment=GroupAlignment.BOTTOM_LEFT,
                                ...
                                elements=(
                                    Key(steno="#", label="#", height=num_bar_key_height),
                                    Key(steno="#-P", height=compound_key_height_small),
                                    Key(steno="-P", label=num_bar_affected_label("P", "7"), height=top_row_key_height),
                            ...
                            KeyGroup(
                                ...
                                elements=(
                                    Key(steno="#", height=num_bar_key_height),
                                    Key(steno="#-L", height=compound_key_height_small),
                                    Key(steno="-L", label=num_bar_affected_label("L", "8"), height=top_row_key_height),
                            ...
                            KeyGroup(
                                ...
                                elements=(
                                    Key(steno="#", grid_location=(0, 0, 1, 3)),
                                    Key(steno="#-T", grid_location=(1, 0)),
                                    Key(steno="#-TD", grid_location=(1, 1)),
                                    Key(steno="#-D", grid_location=(1, 2)),
                                    Key(steno="-T", label=num_bar_affected_label("T", "9"), grid_location=(2, 0)),
                                    Key(steno="-TS", grid_location=(3, 0)),
                                    Key(steno="-S", label="S", grid_location=(4, 0)),
                                    Key(steno="-TD", grid_location=(2, 1)),
                                    Key(steno="-TSDZ", grid_location=(3, 1)),
                                    Key(steno="-SZ", grid_location=(4, 1)),
                                    Key(steno="-D", label="D", grid_location=(2, 2)),
                                    Key(steno="-DZ", grid_location=(3, 2)),
                                    Key(steno="-Z", label="Z", grid_location=(4, 2)),
                                ),
                            ),
                        ),
                    ),
